...
function normalizeCoinFromAPI(apiCoin) {
  return {
    ...
    circulating_supply: apiCoin.circulating_supply != null ? apiCoin.circulating_supply : null,
    total_supply: apiCoin.total_supply != null ? apiCoin.total_supply : null,
    max_supply: apiCoin.max_supply != null ? apiCoin.max_supply : null,
